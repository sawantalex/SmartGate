export const DEPARTMENTS = [
  {
    ...
    icon: "🧪",
    requiredPPE: [
      { id: "helmet", name: "Hard Hat / Safety Helmet", icon: "🪖", mandatory: true },
      { id: "goggles", name: "Chemical Splash Goggles", icon: "🥽", mandatory: true },
      { id: "respirator", name: "Gas Mask / Respirator", icon: "😷", mandatory: true },
      { id: "gloves", name: "Chemical Resistant Nitrile Gloves", icon: "🧤", mandatory: true },
      { id: "vest", name: "High-Visibility Safety Vest", icon: "🦺", mandatory: true },
      { id: "boots", name: "Steel-Toe Chemical Shoes", icon: "🥾", mandatory: true }
    ],
  ...
  },
  {
    ...
    requiredPPE: [
      { id: "helmet", name: "Hard Hat / Safety Helmet", icon: "🪖", mandatory: true },
      { id: "glasses", name: "Impact Safety Glasses", icon: "🥽", mandatory: true },
      { id: "ear", name: "Hearing Protection (Ear Defenders)", icon: "🎧", mandatory: true },
      { id: "cutgloves", name: "Kevlar Cut-Resistant Gloves", icon: "🧤", mandatory: true },
      { id: "vest", name: "High-Vis Reflective Vest", icon: "🦺", mandatory: true },
      { id: "boots", name: "Steel-Toe Safety Boots", icon: "🥾", mandatory: true }
    ],
  ...
  },
  {
    ...
    icon: "⚡",
    requiredPPE: [
      { id: "helmet", name: "Non-Conductive Hard Hat", icon: "🪖", mandatory: true },
      { id: "arcshield", name: "Arc-Flash Face Shield", icon: "🛡️", mandatory: true },
      { id: "rubber-gloves", name: "Dielectric Rubber Gloves", icon: "🧤", mandatory: true },
      { id: "vest", name: "Flame-Resistant High-Vis Vest", icon: "🦺", mandatory: true },
      { id: "boots", name: "Electrical Hazard (EH) Rated Boots", icon: "🥾", mandatory: true }
    ],
  ...
  },
  {
    ...
    icon: "📦",
    requiredPPE: [
      { id: "helmet", name: "Safety Hard Hat", icon: "🪖", mandatory: true },
      { id: "vest", name: "High-Visibility Vest", icon: "🦺", mandatory: true },
      { id: "boots", name: "Steel-Toe Safety Shoes", icon: "🥾", mandatory: true }
    ],
  ...
  },
  {
    ...
    icon: "🔬",
    requiredPPE: [
      { id: "smock", name: "ESD Cleanroom Smock / Bunny Suit", icon: "🥼", mandatory: true },
      { id: "goggles", name: "Safety Glasses", icon: "🥽", mandatory: true },
      { id: "nitrile", name: "Nitrile Gloves", icon: "🧤", mandatory: true },
      { id: "shoecovers", name: "Anti-Static Shoe Covers", icon: "👟", mandatory: true }
    ],
  ...
  },
  {
    ...
    icon: "🏢",
    requiredPPE: [
      { id: "badge", name: "Visitor Pass Badge", icon: "🪪", mandatory: true },
      { id: "vest", name: "High-Vis Vest (Plant Transit)", icon: "🦺", mandatory: false }
    ],
...
export function getDepartmentData(deptId) {
  return DEPARTMENTS.find((d) => d.id === deptId) || DEPARTMENTS[DEPARTMENTS.length - 1]
}
